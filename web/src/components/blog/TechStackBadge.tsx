...
const TECH_COLORS: Record<string, string> = {
  ...
  python: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300",
  ...
  tailwindcss: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300",
  ...
  swift: "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300",
  kotlin: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300",
  ...
  elixir: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300",
  webassembly: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300",
  ...
  firebase: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300",
  supabase: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300",
  prisma: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300",
  drizzle: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300",
  openapi: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300",
...
export function TechStackBadge({ tech, size = "md" }: TechStackBadgeProps) {
  ...
  return (
    ...
    >
      <span className={`rounded-full bg-current opacity-60 ${DOT_SIZE[size]}`} />
      {tech}
    </Badge>
  )
}
